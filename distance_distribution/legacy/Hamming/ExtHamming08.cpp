...
typedef typename ExtHamming08::data_t data_t;

const data_t ExtHamming08::pattern1;
const data_t ExtHamming08::pattern2;
const data_t ExtHamming08::pattern3;
const data_t ExtHamming08::pattern4;

data_t ExtHamming08::compute(
        const data_t value) {
    data_t hamming = 0;
...
data_t ExtHamming08::compute_ext(
        const data_t value) {
    data_t hamming = 0;
