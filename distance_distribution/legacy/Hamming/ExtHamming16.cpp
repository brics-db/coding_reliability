...
typedef typename ExtHamming16::data_t data_t;

const data_t ExtHamming16::pattern1;
const data_t ExtHamming16::pattern2;
const data_t ExtHamming16::pattern3;
const data_t ExtHamming16::pattern4;
const data_t ExtHamming16::pattern5;

data_t ExtHamming16::compute(
        const data_t value) {
    data_t hamming = 0;
...
data_t ExtHamming16::compute_ext(
        const data_t value) {
    data_t hamming = 0;
