...
void run_hamming(uintll_t,int,int);
...
void run_ancoding(uintll_t, uintll_t A, int verbose, uintll_t* minb, uintll_t* mincb,int);
void run_ancoding_cpu(uintll_t, uintll_t A, int verbose, uintll_t* minb, uintll_t* mincb,int);
double run_ancoding_mc(uintll_t, uintll_t, uintll_t A, int, double*, uintll_t* minb, uintll_t* mincb,int);
